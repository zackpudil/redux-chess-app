...
import { ROUTE_PIECE, MOVE_PIECE, TAKE_PIECE, addTakenPiece } from '~/modules/pieces/actions';
import { highlightSquare, selectSquare, clearHighlights, clearCheck, addPiece, removePiece } from '~/modules/squares/actions';
...
export default store => next => action => {
    ...
    case TAKE_PIECE:
      ...
      if(action.type === MOVE_PIECE) {
        ...
        next(addMove(selectedSquare.pieceId, action.toSquareId, selectedSquare.id, false)); // add move to move recorder.
